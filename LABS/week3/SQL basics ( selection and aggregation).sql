...
select distinct district_id, count(district_id) from bank.client group by district_id having district_id < 10 order by district_id;
# Query 14
...
select * from bank.loan;
select account_id, amount from bank.loan order by amount desc limit 10;
# Query 16
